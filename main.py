...
# Global variables
watermark = "GANESH"  # Default value
count = 0
userbot = None
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Ganesh_chouhan_143")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/Ganesh_chouhan_143")        ],
    ]
)
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton("💫 Get Access", url="https://t.me/Ganesh_chouhan_143")]
                    ])
                )
                return
            ...
            await m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📚 Help", url="https://t.me/Ganesh_chouhan_143")]])
            )
...
async def txt_handler(bot: Client, m: Message):  
    ...
    editable = await m.reply_text(
        "𝐇𝐞𝐥𝐥𝐨 𝐮𝐩 𝐰𝐚𝐥𝐢 𝐜𝐡𝐨𝐫𝐢 𝐚𝐛𝐛 𝐭𝐱𝐭 𝐟𝐢𝐥𝐞 𝐬𝐞𝐧𝐝 𝐤𝐚𝐫 ☺️"
    )
