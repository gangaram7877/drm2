...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7732068019:AAGpLm1jKZrVAoR72gWpFGW723K-qIOC0l4")

CREDIT = os.environ.get("CREDIT", "🅖🅐🅝🅔🅢🅗 🅒🅗🅞🅤🅗🅐🅝❤️")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "ganesh")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "6350117077"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6350117077").split()]  # Default to owner ID
